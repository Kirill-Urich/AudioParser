...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Scanning for albums-artists in mp3 files in " << directory << std::endl;
    if (setArtistAlbums(directory)) {
        std::cout << "setArtistAlbums is completed." << std::endl;
    } else {
        std::cout << "setArtistAlbums if failed." << std::endl;
    }
